	...
	return (
		<>
            ...
            <div style={{alignItems:"center", display:"flex",justifyContent:"center", marginTop:'5rem'}}>
                <a href="https://www.producthunt.com/posts/avatars-ai?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-avatars&#0045;ai" target="_blank" rel="noreferrer">
                    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=401032&theme=dark" alt="Avatars&#0032;AI - Personalised&#0032;AI&#0032;Chat&#0032;Companion&#0032;&#0045;&#0032;Powered&#0032;By&#0032;GPT&#0045;4&#0032;&#0038;&#0032;Bard&#0032;AI | Product Hunt" style={{width: "250px", height: "54px"}} width="250" height="54" />
                </a>
            </div>
		</>
	);
